{!! Form::open(['route' => ['contentuses.destroy', $id], 'method' => 'delete']) !!}
<div class='btn-group'>
    <a href="{{ route('contentuses.show', $id) }}" class='btn btn-default btn-xs'>
        <span class="tooltiptext">Show</span><i class="glyphicon glyphicon-eye-open"></i>
    </a>
    {{-- <a href="{{ route('contentuses.edit', $id) }}" class='btn btn-default btn-xs'>
